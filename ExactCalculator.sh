...
cp -f ~/modLOS/android_addons/icons/calcb.xml ~/modLOS/ExactCalculator/res/drawable/ic_launcher_background.xml
cp -f ~/modLOS/android_addons/icons/calcf.xml ~/modLOS/ExactCalculator/res/drawable/ic_launcher_foreground.xml
